    ...
    if (tarifasGridBody) {
        ...
        const tarifasData = [
            ...
            },
            {
                ...
                semana: { precio: '-', alquilado: true },
                porDia: { precio: '-', alquilado: true }
            },
            {
                mes: 'Febrero',
                primerQuincena: { precio: 'USD$1.300', alquilado: false },
                segundaQuincena: { precio: 'USD$1.000', alquilado: false },
                semana: { precio: '-', alquilado: false },
